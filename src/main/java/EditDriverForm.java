 ...
 * @author DELL
 */
public class EditDriverForm extends HttpServlet {
...
out.println("            <th>DriverAddress</th>");
...
out.println("    <tbody>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./EditDriverForm1?Id=" + id + "'>Edit</a>");
