 ...
 * @author DELL
 */
public class DisplayConductorForm1 extends HttpServlet {
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("SELECT * FROM Conductor where Id='"+id+"';");
...
out.println("    <tbody>");
   ...
   out.println("            <td>" + daddress + "</td>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DisplayConductorForm2?ConductorId=" + did + "'>Display</a>");
