 ...
 * @author DELL
 */
public class BusRoute extends HttpServlet {
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            ...
            // Replace the Driver and Conductor Management sections with Bus Route Management

out.println("<br><br><h1 style=\"text-align:center;\"><br><b>Bus Route Management</b></h1>\n" +
...
"        <tr>\n" +
"            <td>\n" +
"                <a href='./InsertBusRoute.html'><button class=\"submit-btn\" onclick=\"insertBusRoute()\">Insert Bus Route</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"                <a href='./DisplayBusRoutes'><button class=\"view-btn link-btn\" onclick=\"displayBusRoute()\">Display Bus Routes</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"               <a href='./EditBusRoutes'><button class=\"edit-btn link-btn\" onclick=\"editBusRoute()\">Edit Bus Route</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"               <a href='./DeleteBusRoute'> <button class=\"delete-btn link-btn\" onclick=\"deleteBusRoute()\">Delete Bus Route</button></a>\n" +
"            </td>\n" +
"        </tr>\n" +
"    </table>\n");
