 ...
 * @author DELL
 */
public class DisplayBusRoute1 extends HttpServlet {
...
out.println("    <tbody>");
    ...
    //String dbusro = rs.getString("StartTime");
      ...
      //out.println("            <td>" + dbusro + "</td>");
       ...
       out.println("            <td>" + det + "</td>");
        //out.println("            <td><a href=\"Documents/" + dl + "\" target=\"_blank\">View DrivingLicense <i class=\"fas fa-eye\"></i></a></td>");
         out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DisplayBusRoute2?Id=" + iid + "'>Display</a>");
