 ...
 * @author DELL
 */
public class DeleteDriverForm1 extends HttpServlet {
...
out.println("    <tbody>");
    ...
    out.println("<form method='post' action='./DeleteDriverForm2'>");
    out.println("        <tr>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DeleteDriverForm2?DriverId=" + did + "'>Delete</a>");
   out.println("            </td>");
    out.println("");
    out.println("");
    out.println("        </tr></form>");
