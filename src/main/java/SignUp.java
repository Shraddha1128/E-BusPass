        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                if (rs.next()) {
                    ...
                    out.println("location='SignUp.html';"); // Redirect back to the signup page
                    out.println("</script>");
                } else {
                PreparedStatement st = con.prepareStatement("insert into Users(Name,Email,UserName,Password,Role) values(?,?,?,?,?);");
                st.setString(1,name );
