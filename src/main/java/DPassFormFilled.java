 ...
 * @author DELL
 */
public class DPassFormFilled extends HttpServlet {
...
"                                <i class=\"fa-solid fa-download sidebar-icons\"></i> <b style=\"font-size: 18px;\">Download Pass</b>\n" +
"                            </a>\n" +
"                        </li>\n" +
"                        <li>\n" +
"                            <a href=\"#\" class=\"nav-link text-white\">\n" +
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("select * from users where Role='Student';");
...
out.println("    <tbody>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DViewForm?Id=" + id + "'>View</a>");
