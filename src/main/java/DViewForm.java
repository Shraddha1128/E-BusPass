 ...
 * @author DELL
 */
public class DViewForm extends HttpServlet {
...
"                        </li>\n" +
"                        <li>\n" +
"                            <a href=\"./DBusRoute\" class=\"nav-link text-white\">\n" +
"                                <i class=\"fa-solid fa-download sidebar-icons\"></i> <b style=\"font-size: 18px;\">Bus Route</b>\n" +
"                            </a>\n" +
"                        </li>\n" +
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("SELECT users.Id,users.Name,users.Email,users.UserName,studentinfo.FirstName,studentinfo.EndDate  FROM `users`JOIN studentinfo on users.UserName=studentinfo.CollegeId ;");
...
out.println("    <tbody>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DViewForm1?UserName=" + user + "'>View</a>");
