 ...
 * @author DELL
 */
public class EditDriverForm2 extends HttpServlet {
...
"            <div class=\"col-12\" style=\"text-align : left;\">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("SELECT * FROM Drivers where DriverId='"+did+"' ;");
...
"        </div>");
    ...
    String dids = rs.getString("DriverId");
    String dname = rs.getString("DriverName");
    String dnum = rs.getString("DriverNumber");
    String daddress = rs.getString("DriverAddress");
    ...
    out.println("<form method=\"post\" action=\"./EditDriverForm3\">\n" +
...
"        <div class=\"row\">\n" +
"            <div class=\"col-md-4\">\n" +
"                <label for=\"drivername\">Enter Driver's Name:</label>\n" +
"                <input type=\"text\" name=\"drivername\" value="+dname+" required>\n" +
"            </div>\n" +
"            <div class=\"col-md-4\">\n" +
"                <label for=\"driverid\">Enter Driver's ID:</label>\n" +
"                <input type=\"text\" name=\"driverid\" value="+dids+" >\n" +
"            </div>\n" +
"            <div class=\"col-md-4\">\n" +
"                <label for=\"drivernum\">Enter Driver's Phone Number:</label>\n" +
"                <input type=\"text\" name=\"drivernum\" value="+dnum+" >\n" +
"            </div>\n" +
"        </div>\n" +
"        <br>\n" +
"        <div class=\"row\">\n" +
"            <div class=\"col-md-12\">\n" +
"                <label for=\"driveraddress\">Enter Driver's Address:</label>\n" +
"                <input type=\"text\" name=\"driveraddress\" value="+daddress+" >\n" +
"            </div>\n" +
"        </div>\n" +
"        \n" +
"        <br>\n" +
...
"                <input type=\"time\" name=\"starttime\" value="+det+">\n" +
"            </div>\n" +
"        </div>\n" +
"\n" +
"        <br>\n" +
