...
"                <div class=\"d-flex flex-column flex-shrink-0 p-3\" style=\"width: 260px;height: 600px; background-color: #3F3DBF; border-radius: 18px 0 0 18px;\">\n" +
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            ...
            out.println("<br><br><h2 style=\"text-align:center;\">Driver Management</h2>\n" +
...
"        <tr>\n" +
"            <td>\n" +
"                <a href='./DriverForm.html'><button class=\"submit-btn\" onclick=\"insertDriver()\">Insert Driver</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"                <a href='./DriverFormDisplay'><button class=\"view-btn link-btn\" onclick=\"displayDriver()\">Display Drivers</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"               <a href='./EditDriverForm'><button class=\"edit-btn link-btn\" onclick=\"editDriver()\">Edit Driver</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"               <a href='./DeleteDriverForm'> <button class=\"delete-btn link-btn\" onclick=\"deleteDriver()\">Delete Driver</button></a>\n" +
"            </td>\n" +
"        </tr>\n" +
"    </table>\n" +
"\n"
                    + "<br><br>" +
"    <h2 style=\"text-align:center;\">Conductor Management</h2>\n" +
"    <table border='1' width='100%' cellpadding='10' style='text-align: center;'>\n" +
"        <tr>\n" +
"            <th>Insert</th>\n" +
"            <th>Display</th>\n" +
...
"        <tr>\n" +
"            <td>\n" +
"                <a href='./ConductorForm.html'><button class=\"submit-btn\" onclick=\"insertConductor()\">Insert Conductor</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"                <a href='./DisplayConductor'><button class=\"view-btn link-btn\" onclick=\"displayConductor()\">Display Conductors</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"                <a href='./EditConductorForm'><button class=\"edit-btn link-btn\" onclick=\"editConductor()\">Edit Conductor</button></a>\n" +
"            </td>\n" +
"            <td>\n" +
"                <a href='./DeleteConductorForm'><button class=\"delete-btn link-btn\" onclick=\"deleteConductor()\">Delete Conductor</button></a>\n" +
"            </td>\n" +
"        </tr>\n" +
"    </table>\n" +
"\n" +
...
"            alert(\"Insert Driver button clicked!\");\n" +
"            // Add logic to insert driver\n" +
"        }\n" +
"\n" +
"        function displayDriver() {\n" +
"            alert(\"Display Driver button clicked!\");\n" +
"            // Add logic to display driver\n" +
"        }\n" +
"\n" +
"        function editDriver() {\n" +
"            alert(\"Edit Driver button clicked!\");\n" +
"            // Add logic to edit driver information\n" +
"        }\n" +
"\n" +
"        function deleteDriver() {\n" +
"            alert(\"Delete Driver button clicked!\");\n" +
"            // Add logic to delete driver information\n" +
"        }\n" +
"\n" +
"        function insertConductor() {\n" +
"            alert(\"Insert Conductor button clicked!\");\n" +
"            // Add logic to insert conductor\n" +
"        }\n" +
"\n" +
"        function displayConductor() {\n" +
"            alert(\"Display Conductor button clicked!\");\n" +
"            // Add logic to display conductor\n" +
"        }\n" +
"\n" +
"        function editConductor() {\n" +
"            alert(\"Edit Conductor button clicked!\");\n" +
"            // Add logic to edit conductor information\n" +
"        }\n" +
"\n" +
"        function deleteConductor() {\n" +
"            alert(\"Delete Conductor button clicked!\");\n" +
"            // Add logic to delete conductor information\n" +
"        }\n" +
"    </script>");
