 ...
 * @author DELL
 */
public class PassFormFilled extends HttpServlet {
...
"                                <i class=\"fa-solid fa-arrow-rotate-right sidebar-icons\"></i> <b style=\"font-size: 18px;\">BusRoute</b>\n" +
"                            </a>\n" +
"                        </li>\n" +
"                        <li>\n" +
...
out.println("    <tbody>");
    ...
    out.println("                <a class='action-btn delete-btn' href='./DeleteForm?Id=" + id + "' >Delete</a>");
    out.println("            </td>");
    out.println("");
    out.println("");
    out.println("        </tr>");
