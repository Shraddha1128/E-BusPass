 ...
 * @author DELL
 */
public class UDriver extends HttpServlet {
...
"                        <li class=\"nav-item\">\n" +
"                            <a href=\"./StudentHomePage.html\" class=\"nav-link active\" style=\"padding-left: 15px; border-radius: 25px; background-color:  #B06DC4\">\n" +
"                                <i class=\"fa-solid fa-house sidebar-icons\"></i><b style=\"font-size: 18px;\">Home</b>\n" +
"                            </a>\n" +
"                        </li>\n" +
"                        <li>\n" +
"                            <a href=\"./PassForm.html\" class=\"nav-link text-white\" style=\"margin-top: 7px;\">\n" +
...
"                        <li>\n" +
"                            <a href=\"./DownloadForm\" class=\"nav-link text-white\">\n" +
"                                <i class=\"fa-solid fa-box-open sidebar-icons\"></i><b style=\"font-size: 18px;\">Download Form </b>\n" +
"                            </a>\n" +
"                        </li>\n"
                    + "<li>\n" +
...
"                        </li>\n" +
"                         <li>\n" +
"                            <a href=\"./RenewForm\" class=\"nav-link text-white\">\n" +
"                                <i class=\"fa-solid fa-box-open sidebar-icons\"></i><b style=\"font-size: 18px;\">RenewForm </b>\n" +
"                            </a>\n" +
"                        </li>" +
"                    </ul>\n" +
"                    <hr>\n" +
...
out.println("            <th>Bus<br>Route<br>Number</th>");
out.println("            <th>Bus<br>Route</th>"); 
out.println("            <th>Start<br>Time</th>");
out.println("            <th>End<br>Time</th>");
out.println("            <th>Driver's<br>Driving<br>License</th>");
out.println("            <th>Conductor's<br>Driving<br>License</th>");
...
out.println("    <tbody>");
    ...
    String cdl = rs.getString("DrivingLicense");
     ...
     out.println("            <td>" + busno + "</td>");
      out.println("            <td>" + dbusro + "</td>");
       ...
       out.println("            <td><a href=\"Documents/" + dl + "\" target=\"_blank\">View DrivingLicense <i class=\"fas fa-eye\"></i></a></td>");
        out.println("            <td><a href=\"Documents/" + cdl + "\" target=\"_blank\">View DrivingLicense <i class=\"fas fa-eye\"></i></a></td>");
