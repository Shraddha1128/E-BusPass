 ...
 * @author DELL
 */
public class DriverFormDisplay extends HttpServlet {
...
"                                <i class=\"fa-solid fa-arrow-rotate-right sidebar-icons\"></i> <b style=\"font-size: 18px;\">ReNew Pass</b>\n" +
"                            </a>\n" +
"                        </li>\n" +
"                        <li>\n" +
"                            <a href=\"#\" class=\"nav-link text-white\">\n" +
...
out.println("            <th>DriverId</th>");
out.println("            <th>Driver<br>Name</th>");
out.println("            <th>Driver<br>Address</th>");
     ...
     out.println("            <td>" + busno + "</td>");
      out.println("            <td>" + dbusro + "</td>");
       ...
       out.println("            <td>" + det + "</td>");
        ...
        out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DisplayDriverForm1?Id=" + id + "'>Display</a>");
