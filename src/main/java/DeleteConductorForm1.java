 ...
 * @author DELL
 */
public class DeleteConductorForm1 extends HttpServlet {
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            try
            {
                ...
                out.println("<div class=\"col-9\" style=\"text-align: center;\">\n" +
"    <table>\n" +
"        <thead>"
                        + "<tr>");
...
out.println("    <tbody>");
    ...
    out.println("<form method='post' action='./DeleteConductorForm2'>");
    out.println("        <tr>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DeleteConductorForm2?ConductorId=" + did + "'>Delete</a>");
   out.println("            </td>");
    out.println("");
    out.println("");
    out.println("        </tr></form>");
