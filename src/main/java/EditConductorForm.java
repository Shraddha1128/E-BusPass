 ...
 * @author DELL
 */
public class EditConductorForm extends HttpServlet {
...
"        margin-top: 30px;"
                    + "margin-left: 0px;  /* Adjust this value if needed */\n" +
"        margin-right: 0px;"+
...
"                        </li>\n" +
"                         <li>\n" +
"                            <a href=\"./BusRoutes\" class=\"nav-link text-white\">\n" +
...
"            <div class=\"col-9\" \">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("SELECT * FROM Conductor ;");
                ResultSet rs = st.executeQuery();
                out.println("<table style='margin-right : 30px;'>");
out.println("    <thead>");
out.println("        <tr>");
//out.println("            <th>ID</th>");
out.println("            <th>ConductorId</th>");
out.println("            <th>Conductor<br>Name</th>");
out.println("            <th>Conductor<br>Address</th>");
...
out.println("            <th>Driving<br>License</th>");
...
out.println("    <tbody>");
    ...
    String did = rs.getString("ConductorId");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./EditConductorForm1?Id=" + id + "'>Edit</a>");
    //out.println("                <a class='action-btn edit-btn' href='./EditForm?Id=" + id + "'>Edit</a>");
    //out.println("                <a class='action-btn delete-btn' href='./DeleteForm?Id=" + id + "' onclick='return confirm(\"Are you sure you want to delete ID: " + id + "?\");'>Delete</a>");
    out.println("            </td>");
    out.println("");
    out.println("");
    out.println("        </tr>");
