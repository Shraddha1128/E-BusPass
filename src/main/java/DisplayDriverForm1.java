 ...
 * @author DELL
 */
public class DisplayDriverForm1 extends HttpServlet {
...
"            <div class=\"col-9\" style=\"text-align : left;\">");
            try
            {
                ...
                PreparedStatement st = con.prepareStatement("SELECT * FROM Drivers where Id='"+id+"';");
...
out.println("    <tbody>");
    ...
    out.println("            <td>");
    out.println("                <a class='action-btn view-btn' href='./DisplayDriverForm2?DriverId=" + did + "'>Display</a>");
