...
"                        </li>\n" +
"                        <li>\n" +
"                            <a href=\"./Bus Route\" class=\"nav-link text-white\">\n" +
...
out.println("    <tbody>");
    ...
    out.println("                <a class='action-btn edit-btn' href='./EditForm1?Id=" + id + "'>Edit</a>");
    out.println("                <a class='action-btn delete-btn' href='./DeleteForm1?UserName=" + user + "'>Delete</a>");
    out.println("            </td>");
    out.println("");
    out.println("");
    out.println("        </tr>");
